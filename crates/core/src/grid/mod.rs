...
//! [`put_tile`](crate::grid::Grid::put_tile), [`cells_mut_or_alloc`](crate::grid::Grid::cells_mut_or_alloc)): a
...
//! ([`tile_mut`](crate::grid::Grid::tile_mut), [`cells_mut`](crate::grid::Grid::cells_mut),
//! [`cells_mut_or_alloc`](crate::grid::Grid::cells_mut_or_alloc), `IndexMut`), which cannot intercept the
...
pub(crate) struct LayerBuf {
    ...
    /// a tint, which is what keeps [`Tile`](crate::tile::Tile) itself small (see [`Grid::grapheme`](crate::grid::Grid::grapheme) and
    /// [`Grid::tint`](crate::grid::Grid::tint)).
    ///
