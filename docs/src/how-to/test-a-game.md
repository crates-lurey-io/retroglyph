...
[`Headless::format_view`](https://docs.rs/retroglyph-core/latest/retroglyph_core/backend/headless/struct.Headless.html#method.format_view)
...
[`Headless::format_styled`](https://docs.rs/retroglyph-core/latest/retroglyph_core/backend/headless/struct.Headless.html#method.format_styled),
for tests that also need to assert on foreground/background/attributes rather than plain glyphs.

## Driving input

[`Headless::push_event`](https://docs.rs/retroglyph-core/latest/retroglyph_core/backend/headless/struct.Headless.html#method.push_event)
