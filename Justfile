...
doc-gen:
    cargo clean --doc
    cargo doc --no-deps
    echo '<meta http-equiv="refresh" content="0;url=retroglyph/index.html">' > target/doc/index.html
    rm target/doc/.lock
...
coverage *ARGS:
    cargo tool cargo-llvm-cov --open --lib --no-dev-deps

coverage-gen:
    cargo tool cargo-llvm-cov --lcov --output-path lcov.info --lib --no-dev-deps
