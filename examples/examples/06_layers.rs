...
impl Layers {
    ...
    fn draw<B: Backend>(&self, term: &mut Terminal<B>) {
        ...
        surface.print(
            (1, 1),
            "Layer 0: background fill. Layer 1: moving glyph.",
            Style::default(),
        );
