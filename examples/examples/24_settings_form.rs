...
//!
//! `TextInput` has no [`InteractiveWidget`](retroglyph_ui::widget::InteractiveWidget) impl (unlike
...
/// an [`retroglyph_ui::widget::InteractiveWidget`], so this hand-rolls what `ui.show`/
