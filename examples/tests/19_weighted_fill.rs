//! Snapshot tests for the `19_weighted_fill` example.
//!
...
#[path = "../examples/19_weighted_fill.rs"]
...
#[test]
fn svg_snapshot() {
    let bin = support::build_crossterm_example("19_weighted_fill");
    ...
    support::write_snapshot_file("19_weighted_fill.svg", svg.as_bytes());
